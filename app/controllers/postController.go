...
func GetAllPosts(c *fiber.Ctx) error {
	...
	for _, post := range posts {
		...
		models.ParseToPostResponse(post, pr)
...
func GetPostByID(c *fiber.Ctx) error {
	...
	models.ParseToPostResponse(*post, postResponse)
...
func CreatePost(c *fiber.Ctx) error {
	...
	models.ParseToPostResponse(*newPost, newPostResponse)
...
func UpdatePost(c *fiber.Ctx) error {
	...
	if err != nil {
		return c.Status(fiber.StatusBadRequest).JSON(fiber.Map{
			"error": "error to parside the id parameter",
		})
	}
	...
	models.ParseToPostResponse(*updatePost, updatePostResponse)
